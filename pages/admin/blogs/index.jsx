...
import { AspectRatio, Button, chakra, Container, Flex, FormControl, FormErrorMessage, FormLabel, Image, Input, InputGroup, InputLeftElement, Select, SimpleGrid, Text, Textarea, useDisclosure } from '@chakra-ui/react'
							...
							<Flex direction="column" gap={6}>
								...
								<Flex direction="column" gap={3}>
									...
									<Text fontSize="sm" color="accent-1" noOfLines={3}>
										Lorem ipsum dolor sit amet consectetur elit Atque vero aliquid nostrum nemo maxime quas numquam sed corporis illo ab, odio qui debitis asperiores Aspernatur odio saepe quae.
									</Text>
